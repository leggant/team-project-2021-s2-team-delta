            ...
            <table dusk="student_table_{{$loop->iteration}}" class="max-h-min">
                <thead>
                    <tr>
                        ...
                        <th class="md:px-4 py-2">Username</th>
                        <th class="md:px-4 py-2">Github</th>
                        <th class="md:px-4 py-2">Email</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="border md:py-2 px-2 text-center">{{$s->username}}</td>
                        <td class="border md:py-2 px-2 text-center">
            ...
            <form action="{{route('enable')}}" method="POST">
                ...
                <table id="studentTable" class="w-full">
                    ...
                    <tr>
                        ...
                        <td class="border py-2 md:px-2 text-center">{{$s->name}}</td>
                        <td class="border py-2 md:px-2 text-center">{{$s->username}}</td>
