        ...
        <form action="{{ route('notes.store') }}" method="post">
            ...
            <div
                ...
                <textarea rows="5" name="notes" required placeholder="Enter A Note...."
                   dusk="noteinput" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm block lg:col-span-2 resize-none"></textarea>
                <input type="hidden" name="user_id" value="{{ Auth::id() }}">
