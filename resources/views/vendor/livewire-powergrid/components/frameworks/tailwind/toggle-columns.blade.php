@if($toggleColumns)
    <div x-data="toggleColumns()"
        ...
        <button @click.prevent="open = ! open"
                class="block bg-white-200 text-gray-900 border border-gray-300 rounded py-1.5 px-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-600 dark:border-gray-500 dark:bg-gray-500 2xl:dark:placeholder-gray-300 dark:text-gray-200 dark:text-gray-300">
            <div class="flex">
                <x-livewire-powergrid::icons.eye-off class="text-gray-900 dark:text-gray-300"/>
            </div>
        </button>
