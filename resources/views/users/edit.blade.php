        ...
        <form action="{{ route('users.update', $user->id) }}" method='POST' class="grid gap-4 grid-cols-1">
            ...
            <div>
                ...
                <select id="paper" name="Papers[]" multiple required
                    class="block px-4 py-3 rounded appearance-none w-min bg-white border border-gray-400 hover:border-gray-500 pr-8shadow leading-tight focus:outline-none focus:shadow-outline form-input">
